...
declare class HydraProvider implements IFetcher, ISubmitter {
    ...
    private readonly _axiosInstance;
    constructor({ url, history, address, }: {
        url: string;
        history?: boolean;
        address?: string;
    });
     ...
     * @param description
     */
    newTx(cborHex: string, type: "Tx ConwayEra" | "Unwitnessed Tx ConwayEra" | "Witnessed Tx ConwayEra", description?: string, txId?: string): Promise<void>;
    /**
     ...
     * @param description
     */
    decommit(cborHex: string, type: "Tx ConwayEra" | "Unwitnessed Tx ConwayEra" | "Witnessed Tx ConwayEra", description: string): Promise<void>;
    /**
...
export { BeginProvider, BlockfrostProvider, type BlockfrostSupportedNetworks, HydraInstance, HydraProvider, KoiosProvider, type KoiosSupportedNetworks, MaestroProvider, type MaestroSupportedNetworks, OfflineFetcher, OgmiosProvider, U5CProvider, YaciProvider };
