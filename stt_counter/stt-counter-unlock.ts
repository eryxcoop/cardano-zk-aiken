  ...
  async function main() {
    ...
    // build transaction with MeshTxBuilder
      ...
      await txBuilder
        ...
        .txInRedeemerValue(mConStr0([(1)])) // provide the required redeemer value `Hello, World!`
        .txInDatumValue(mConStr0([0])) // only the owner of the wallet can unlock the funds
