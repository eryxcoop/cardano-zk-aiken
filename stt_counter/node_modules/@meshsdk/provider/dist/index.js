...
// src/hydra/hydra-instance.ts
var HydraInstance = class {
  provider;
...
var HydraProvider = class {
   ...
   * @param description
   */
  async newTx(cborHex, type, description = "", txId) {
    const transaction = {
      type,
      description,
      cborHex,
   ...
   * @param description
   */
  async decommit(cborHex, type, description) {
    const payload = {
      tag: "Decommit",
      transaction: {
        type,
