use crate::deprecated_replace_offchain_by_zk_in_src;
...
fn test_empty_replacement() {
    ...
    assert_eq!(
        ...
        deprecated_replace_offchain_by_zk_in_src(&program_without_offchain)
    );
}
...
fn test_single_replacement_for_addition_with_constant_params() {
    ...
    assert_eq!("zk[4+5=9]", deprecated_replace_offchain_by_zk_in_src(&program_only_offchain));
}
...
fn test_single_replacement_for_addition_with_constant_params_in_context() {
    ...
    assert_eq!(
        "let a = 4\nzk[4+5=9]\nlet a = 4",
        deprecated_replace_offchain_by_zk_in_src(&program_only_offchain)
    );
}
...
fn test_single_replacement_for_subtraction_with_constant_params() {
    ...
    assert_eq!("zk[10-5=5]", deprecated_replace_offchain_by_zk_in_src(&program_only_offchain));
}
...
fn test_single_replacement_for_multiplication_with_constant_params() {
    ...
    assert_eq!("zk[4*5=20]", deprecated_replace_offchain_by_zk_in_src(&program_only_offchain));
}
